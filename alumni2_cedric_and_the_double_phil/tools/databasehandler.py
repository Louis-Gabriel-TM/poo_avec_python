...
class DatabaseHandler:
    def __init__(self, ctl_ref):
        ...
        self.connector = sqlite3.connect("D:\\NEA\\Alternance\\Python\\Alumni v3 Philippe Philomene Cedric\\databases\\database.sq3")
    ...
    def get_profile(self, table):
        ...
        if table == "student":
            ...
            user_password = getpass.getpass("Entrer un mot de passe : ")
